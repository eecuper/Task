	...
	if($r1_Code=="1"){
		...
		if($r9_BType=="1"){
				...
				if($flag==0){
			 	 ...
			 	 $sql = "update task_user_charge set cg_baozj=cg_baozj+".floatval($r3_Amt)." where user_id=".$r8_MP;
				 $type_name='保证金充值';
				 ...
				 if($up_db){
					 	...
					 	$sql="insert into task_charge_log 
						 	 						...
						 	 						values 
						 	 						(4,".$r3_Amt.",".time().",".$r8_MP.",'TK Num:".$r6_Order."',".$r6_Order.",1)";
					 	//echo $sql.'<br>';
			 		 	$cz_log = mysql_query($sql);
			 		 	//echo 'insert_sql : '.$cz_log.mysql_error().'<br>';
